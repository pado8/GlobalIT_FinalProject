...
@Data
public class RequestPageResponseDTO<E> {
    ...
    @Builder
    public RequestPageResponseDTO(List<E> dtoList, RequestPageRequestDTO RequestPageRequestDTO, long totalCount) {
        this.dtoList = dtoList;
        this.totalCount = (int) totalCount;
        this.size = RequestPageRequestDTO.getSize();
        this.currentPage = RequestPageRequestDTO.getPage();
